...
function playTone(freq, duration, volume, type = "sine", fadeOut = true) {
  try {
    const ctx = getCtx();
...
function useSoundManager(enabled) {
  const bgmNodesRef = reactExports.useRef([]);
  const bgmIntervalRef = reactExports.useRef(null);
  const bgmRunningRef = reactExports.useRef(false);
  const playPop = reactExports.useCallback(
    (pitch = 1) => {
      if (!enabled) return;
  ...
  const playShoot = reactExports.useCallback(() => {
    if (!enabled) return;
    playNoise(0.15, 0.15, 800);
    playTone(200, 0.1, 0.1, "sawtooth");
  }, [enabled]);
  const playCombo = reactExports.useCallback(
    (size) => {
      if (!enabled) return;
  ...
  const playWin = reactExports.useCallback(() => {
    if (!enabled) return;
  ...
  const playBomb = reactExports.useCallback(() => {
    if (!enabled) return;
    playNoise(0.3, 0.4, 200);
    playTone(80, 0.3, 0.3, "sawtooth");
  }, [enabled]);
  const playIntro = reactExports.useCallback(() => {
    if (!enabled) return;
  ...
  const startBgm = reactExports.useCallback(() => {
  ...
  const stopBgm = reactExports.useCallback(() => {
...
function GameOver({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "game-frame rounded-3xl p-8 flex flex-col items-center gap-5 w-80", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl", children: "💔" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-black text-white", children: "Game Over" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/60 text-sm", children: [
          "Reached Level ",
          level
        ] }),
        isNewHigh && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-yellow-400/20 border border-yellow-400/50 rounded-2xl px-6 py-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-yellow-300 font-black text-lg", children: "🏆 New High Score!" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-6 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/60 text-xs font-bold uppercase tracking-wide", children: "Score" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-black text-yellow-300", children: score.toLocaleString() })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/60 text-xs font-bold uppercase tracking-wide", children: "Best" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-black text-yellow-300", children: highScore.toLocaleString() })
          ] })
        ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "game-frame rounded-3xl p-8 flex flex-col items-center gap-5 w-80", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl font-black text-white text-glow-cyan", children: [
          "Level ",
          level,
          " Clear!"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: "text-5xl",
            style: {
              ...
              filter: shownStars >= i && i <= stars ? "drop-shadow(0 0 12px rgba(255,211,59,0.9))" : "grayscale(1)"
            },
            children: i <= stars ? "⭐" : "☆"
          },
          i
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-6 text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/60 text-xs font-bold uppercase tracking-wide", children: "Coins" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-2xl font-black text-yellow-300", children: [
              "+",
              coins,
              " 🪙"
            ] })
...
function PauseOverlay({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "game-frame rounded-3xl p-8 flex flex-col items-center gap-5 w-72", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-black text-white", children: "⏸ Paused" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-white/70 text-sm", children: [
          "Level ",
          level,
          "  |  Score: ",
...
function randomBubble(levelIdx) {
...
function drawBubble(ctx, x, y, r, color, special, iceHits = 0, alpha = 1, t = 0) {
  ctx.save();
  ...
  if (special === "rainbow") {
    ...
    const iceColor = iceHits > 0 ? "rgba(160,210,255,0.85)" : "rgba(200,235,255,0.92)";
    ctx.beginPath();
    ctx.arc(x, y, r, 0, Math.PI * 2);
...
function drawShooter(ctx, angle, currBubble, t) {
  ctx.save();
  ctx.translate(SX, SY);
...
function GameScreen({
  ...
  const [uiShots, setUiShots] = reactExports.useState(0);
  const [uiLevel, setUiLevel] = reactExports.useState(level);
  const [status, setStatus] = reactExports.useState("playing");
  const [stars, setStars] = reactExports.useState(1);
  const [coins, setCoins] = reactExports.useState(10);
  const gridRef = reactExports.useRef([]);
  const travelRef = reactExports.useRef(null);
  const fallingRef = reactExports.useRef([]);
  const particlesRef = reactExports.useRef([]);
  const floatScoresRef = reactExports.useRef([]);
  const currentBubRef = reactExports.useRef({
    color: "blue",
    special: "normal"
  });
  const nextBubRef = reactExports.useRef({
    color: "green",
    special: "normal"
  });
  const aimAngleRef = reactExports.useRef(-Math.PI / 2);
  const isAimingRef = reactExports.useRef(false);
  const scoreRef = reactExports.useRef(0);
  const shotsRef = reactExports.useRef(25);
  const levelRef = reactExports.useRef(level);
  const statusRef = reactExports.useRef("playing");
  const timeRef = reactExports.useRef(0);
  const bgParticlesRef = reactExports.useRef([]);
  const sounds = useSoundManager(soundEnabled);
  const initLevel = reactExports.useCallback((lvlIdx) => {
  ...
  function floodFill(startR, startC, color, special) {
    var _a3;
    ...
    while (queue.length > 0) {
      ...
      visited.add(key);
      const cell = (_a3 = grid[r]) == null ? void 0 : _a3[c];
      if (!cell) continue;
      const isMatch = special === "rainbow" || cell.special === "rainbow" || cell.color === color;
      if (!isMatch) continue;
  ...
  function findOrphans() {
    ...
    const queue = [];
    for (let c = 0; c < CE; c++) {
      if ((_a3 = grid[0]) == null ? void 0 : _a3[c]) queue.push({ r: 0, c });
    }
    while (queue.length > 0) {
      const item = queue.shift();
      const { r, c } = item;
      ...
      if (!((_b2 = grid[r]) == null ? void 0 : _b2[c])) continue;
      connected.add(key);
      for (const n of getNeighbors(r, c)) {
        if (validCell(n.r, n.c) && !connected.has(`${n.r},${n.c}`) && ((_c2 = grid[n.r]) == null ? void 0 : _c2[n.c])) {
          queue.push(n);
        }
      }
    }
    ...
    for (let r = 0; r < grid.length; r++) {
      for (let c = 0; c < (((_d2 = grid[r]) == null ? void 0 : _d2.length) ?? 0); c++) {
  ...
  function processPop(matches) {
    var _a3, _b2, _c2, _d2;
    const grid = gridRef.current;
    if (matches.length < 3) return;
    const comboMult = matches.length >= 12 ? 5 : matches.length >= 8 ? 3 : matches.length >= 5 ? 2 : 1;
    let points = 0;
    const toRemove = [];
    for (const m of matches) {
      const cell = (_a3 = grid[m.r]) == null ? void 0 : _a3[m.c];
      if (!cell) continue;
    ...
    for (const { r, c } of toRemove) {
      const cell = (_b2 = grid[r]) == null ? void 0 : _b2[c];
      if (!cell) continue;
    ...
    for (const { r, c } of orphans) {
      const cell = (_c2 = grid[r]) == null ? void 0 : _c2[c];
      if (!cell) continue;
      const { x, y } = cellPx(r, c);
    ...
    if (isGridEmpty()) {
      const shotLimit = ((_d2 = LEVELS[levelRef.current]) == null ? void 0 : _d2.shotLimit) ?? 25;
  ...
  function processBomb(r, c) {
    ...
    while (queue.length > 0) {
      ...
      if (visited.has(key)) continue;
      visited.add(key);
      const { x: bx2, y: by2 } = cellPx(r, c);
      const { x: tx, y: ty } = cellPx(item.r, item.c);
      if (Math.hypot(bx2 - tx, by2 - ty) <= BD * 2.5) {
        if ((_a3 = grid[item.r]) == null ? void 0 : _a3[item.c]) toRemove.push(item);
    ...
    for (const { r: tr, c: tc } of toRemove) {
      const cell = (_b2 = grid[tr]) == null ? void 0 : _b2[tc];
      if (!cell) continue;
    ...
    for (const { r: or, c: oc } of orphans) {
      const cell = (_c2 = grid[or]) == null ? void 0 : _c2[oc];
      if (!cell) continue;
  ...
  function snapBubble(tb) {
    ...
    if (bestR === -1) return;
    ensureRow(bestR);
    const cell = { color: tb.color, special: tb.special, iceHits: 0 };
    ...
    if (shotsRef.current <= 0 && !isGridEmpty() && statusRef.current === "playing") {
      statusRef.current = "gameover";
      setStatus("gameover");
    }
  }
  function checkCollision(tb) {
    var _a3;
    if (tb.y <= GT + BR) return true;
    const grid = gridRef.current;
    for (let r = 0; r < grid.length; r++) {
      for (let c = 0; c < (((_a3 = grid[r]) == null ? void 0 : _a3.length) ?? 0); c++) {
  ...
  reactExports.useEffect(() => {
    ...
    const onMD = (e) => handlePointerDown(e.clientX, e.clientY);
    const onMM = (e) => handlePointerMove(e.clientX, e.clientY);
    const onMU = (e) => handlePointerUp(e.clientX, e.clientY);
    const onTD = (e) => {
      e.preventDefault();
      const t = e.touches[0];
  ...
  const [currentLevel, setCurrentLevel] = reactExports.useState(level);
  ...
  const dangerBubbles = gridRef.current.some(
    (row) => row == null ? void 0 : row.some((cell) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { lineHeight: 0 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "canvas",
          {
            ref: canvasRef,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: { width: ((_a2 = canvasRef.current) == null ? void 0 : _a2.style.width) || "100%" },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-3 py-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/50 text-xs font-bold uppercase tracking-wider", children: "Score" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-yellow-300 text-xl font-black", children: uiScore.toLocaleString() })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/50 text-xs font-bold uppercase tracking-wider", children: "Level" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-cyan-300 text-xl font-black", children: uiLevel })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/50 text-xs font-bold uppercase tracking-wider", children: "Shots" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
              ...
              dangerBubbles && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-red-400 text-xs font-bold animate-pulse", children: "⚠ Bubbles too close!" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        status === "levelcomplete" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          LevelComplete,
          {
            level: uiLevel,
            score: uiScore,
        ...
        status === "gameover" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          GameOver,
          {
            score: uiScore,
            highScore,
...
function MainMenu({
  ...
  const canvasRef = reactExports.useRef(null);
  const rafRef = reactExports.useRef(0);
  const [showHow, setShowHow] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        background: "radial-gradient(ellipse at 50% 30%, #1B0F3A 0%, #0B0F1F 50%, #070A12 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "canvas",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: { maxWidth: 360 },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h1",
                  {
                    ...
                    style: {
                      background: "linear-gradient(135deg, #FF7A3C 0%, #FFD43B 40%, #3DFF7A 70%, #3BA7FF 100%)",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-black text-white text-glow-cyan tracking-widest", children: "MASTER" })
              ] }),
              highScore > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-yellow-300 text-sm font-bold", children: [
                "🏆 Best: ",
        ...
        showHow && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-black text-white mb-4 text-center", children: "How to Play" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm text-white/90", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                      "🎯 ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Aim" }),
                      " — drag/tap above the cannon"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                      "🫧 ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Match 3+" }),
                      " same-color bubbles to pop them"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                      "💥 ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Bomb" }),
                      " — explodes nearby bubbles"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                      "🌈 ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Rainbow" }),
                      " — matches any color"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                      "❄️ ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Ice" }),
                      " — needs 2 hits to break"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                      "🔥 ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Fire" }),
                      " — destroys row below it"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                      "⭐ ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Combos" }),
                      " earn bonus points!"
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-4 text-white/30 text-xs", children: [
          "© ",
...
function SplashScreen({ onDone }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "relative w-full h-full flex flex-col items-center justify-center overflow-hidden",
      style: {
        background: "radial-gradient(ellipse at center, #1B0F3A 0%, #0B0F1F 60%, #070A12 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("canvas", { ref: canvasRef, className: "absolute inset-0 w-full h-full" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 pointer-events-none", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, rgba(255,61,166,0.2) 0%, transparent 70%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, rgba(23,182,255,0.2) 0%, transparent 70%)"
              }
            }
          )
        ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
              ...
              style: {
                ...
                background: "linear-gradient(135deg, #FF7A3C, #FFD43B, #3DFF7A, #3BA7FF, #B04BFF)",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
                backgroundClip: "text",
...
function App() {
  ...
  const updateHighScore = reactExports.useCallback(
    (s) => {
      if (s > highScore) {
        setHighScore(s);
        try {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        screen === "splash" && /* @__PURE__ */ jsxRuntimeExports.jsx(SplashScreen, { onDone: () => setScreen("menu") }),
        ...
        screen === "game" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          GameScreen,
          {
            level,
            soundEnabled,
